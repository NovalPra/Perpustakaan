...
@section('isihalaman')
    ...
    <h3><center>Perpustakaan Universitas Amikom</center></h3>
    ...
    <tr>
        ...
        <td>{{ $p->petugas->nama_petugas ?? 'Tidak ditemukan' }}</td>
        <td>{{ $p->anggota->nama_anggota ?? 'Tidak ditemukan' }}</td>
        <td>{{ $p->buku->judul ?? 'Tidak ditemukan' }}</td>
        <td align="center">
                                    ...
                                    <div class="col-sm-8">
                                        <select type="text" class="form-control" id="id_petugas" name="id_petugas">
                                            @foreach ($petugas as $pt)
                                                <option value="{{ $pt->id_petugas }}" {{ $pt->id_petugas == $p->id_petugas ? 'selected' : '' }}>
                                                    {{ $pt->nama_petugas }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-8">
                                        <select type="text" class="form-control" id="id_anggota" name="id_anggota">
                                            @foreach ($anggota as $a)
                                                <option value="{{ $a->id_anggota }}" {{ $a->id_anggota == $p->id_anggota ? 'selected' : '' }}>
                                                    {{ $a->nama_anggota }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select type="text" class="form-control" id="id_buku" name="id_buku">
                                            @foreach ($buku as $bk)
                                                <option value="{{ $bk->id_buku }}" {{ $bk->id_buku == $p->id_buku ? 'selected' : '' }}>
                                                    {{ $bk->judul }}
                                                </option>
                                            @endforeach
                                        </select>
